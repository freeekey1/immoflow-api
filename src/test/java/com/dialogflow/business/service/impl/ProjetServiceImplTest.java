...
import com.dialogflow.test.ProjetEntityFactoryForTest;
...
public class ProjetServiceImplTest {
	...
	public void create() {
		...
		when(projetJpaRepository.findOne(projet.getId().intValue())).thenReturn(null);
	...
	public void createKOExists() {
		...
		ProjetEntity projetEntity = projetEntityFactoryForTest.newProjetEntity();
		when(projetJpaRepository.findOne(projet.getId().intValue())).thenReturn(projetEntity);
