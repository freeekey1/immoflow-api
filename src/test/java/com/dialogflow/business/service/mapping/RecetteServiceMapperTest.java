...
public class RecetteServiceMapperTest {
	...
	public void testMapRecetteEntityToRecette() {
		...
		recetteEntity.setBanque(mockValues.nextInteger());
		recetteEntity.setMontant(mockValues.nextFloat());
		recetteEntity.setDateDepot(mockValues.nextDate());
		recetteEntity.setRefVille(mockValues.nextInteger());
		recetteEntity.setNomPayeur(mockValues.nextString(100));
		recetteEntity.setNumRecette(mockValues.nextString(100));
		recetteEntity.setRefModeRecette(mockValues.nextInteger());
		...
		recetteEntity.setRefEcheance(mockValues.nextInteger());
		recetteEntity.setDateVersement(mockValues.nextDate());
		recetteEntity.setCinPayeur(mockValues.nextString(30));
		recetteEntity.setOrdre(mockValues.nextInteger());
		recetteEntity.setDossier(new DossierEntity());
		recetteEntity.getDossier().setId(mockValues.nextInteger());
		...
		assertEquals(recetteEntity.getDateVersement(), recette.getDateVersement());
		assertEquals(recetteEntity.getCinPayeur(), recette.getCinPayeur());
		assertEquals(recetteEntity.getOrdre(), recette.getOrdre());
	...
	public void testMapRecetteToRecetteEntity() {
		...
		recette.setBanque(mockValues.nextInteger());
		recette.setMontant(mockValues.nextFloat());
		recette.setDateDepot(mockValues.nextDate());
		recette.setRefVille(mockValues.nextInteger());
		recette.setNomPayeur(mockValues.nextString(100));
		recette.setNumRecette(mockValues.nextString(100));
		recette.setRefModeRecette(mockValues.nextInteger());
		...
		recette.setRefEcheance(mockValues.nextInteger());
		recette.setDateVersement(mockValues.nextDate());
		recette.setCinPayeur(mockValues.nextString(30));
		recette.setOrdre(mockValues.nextInteger());
		recette.setRefDossier(mockValues.nextInteger());
		...
		assertEquals(recette.getDateVersement(), recetteEntity.getDateVersement());
		assertEquals(recette.getCinPayeur(), recetteEntity.getCinPayeur());
		assertEquals(recette.getOrdre(), recetteEntity.getOrdre());
